...
客户端再次拒绝成人标记、Ecchi／Hentai 类型、敏感／成人标签、命中本地敏感词的作品名或角色名、不安全链接、少于 1 个 MAIN 或少于 3 个 SUPPORTING 的作品。拉丁字母关键词使用单词边界以减少误杀。题目只问：四名候选中哪一名被 AniList 标为 MAIN。成人过滤不能被宣传为适合所有平台的完整分级。
