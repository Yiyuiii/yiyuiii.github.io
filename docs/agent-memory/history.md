...
- 2026-08-07：用户指出《SETI》教程虽已覆盖规则，但没有集中教初学者识读通用图标、扇区第一格／恒星旁等标记状态和八种物种的专属图标。本轮按官方主规则书、四页玩家辅助与八种物种辅助页完成闭环审计，追加两张官方图并补齐版图、图标和物种“版图读法”；精确内容、图片数量和验证证据以当前中英文文章、`docs/article-assets/202608021600.yml`、`docs/seti-rules-audit-2026-08-04.md` 与现行测试为准。
