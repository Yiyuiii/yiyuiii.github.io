...
- 2026-08-03：用户要求在每个正式页面底部增加基于 GitHub 的评论；本轮启用仓库 Discussions，并以 Giscus、严格路径映射、显式点击加载、双语与主题同步、来源限制和 GitHub 直达回退实现。Giscus App 的仓库级授权仍必须在正式发布前单独确认；精确边界以全站评论计划和当前测试为准。
